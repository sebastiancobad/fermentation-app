...
```
 ...
 Wk 1─12          Wk 13─24         Wk 25─36           Wk 37─52        Wk 53─68
 ──────────────────────────────────────────────────────────────────────────────
 │                │                │                  │               │
 │ Data Sourcing  │ Pipe Sizing    │ Material Sel.    │ Distillation  │ P&ID Dev
 │ Thermo Eng     │ Phase Sep.     │ Pump Sizing      │ Process Safety│ Collab
 │ Component DB   │ Heat Exchanger │ PSV/PRV          │ APC           │ Integr.
 │ Unit Conv      │ Datasheets     │ Economics        │ Plant Layout  │ Polish
 │ API Shell      │ Project CRUD   │ Cross-Module     │ Phase Envelope│
 │ Auth + UI      │                │                  │               │
 │                │                │                  │               │
 ──────────────────────────────────────────────────────────────────────────────
  Q1─Q2 2026        Q2─Q3 2026       Q3─Q4 2026       Q4 2026─       Q2─Q3
                                                        Q1 2027       2027
```
...
> **Timeline rationale:** Phase 0 was expanded from the original 8 weeks to 12 weeks. Building a validated thermodynamic engine (PR EOS + NRTL + flash calculations) and loading 500 compounds with DIPPR correlations is the single most technically challenging phase. Reference: open-source projects like `thermo` (Caleb Bell) and CoolProp took years of development. 12 weeks with 2 dedicated backend engineers is aggressive but achievable if data sourcing is parallelized.

### Sprint 1–2 (Weeks 1–4): Infrastructure & Data Sourcing
...
| **DIPPR 801 license procurement** | Lead | License secured or NIST open-data fallback confirmed |
| **ETL pipeline for component data** | Data Eng | Automated script to parse, validate, and load DIPPR/NIST data |
| **Seed 50 reference compounds** (light gases + C1–C10) | Data Eng | All properties validated against CoolProp within ±1% |

### Sprint 3–4 (Weeks 5–8): Thermodynamic Engine Core
...
### Sprint 5–6 (Weeks 9–12): Data Completion & Validation

| Task | Owner | Acceptance Criteria |
|---|---|---|
| Load remaining 450 compounds | Data Eng | All critical properties + DIPPR correlations |
| Automated regression test suite vs. CoolProp | Backend | 500 components × 6 properties within tolerance |
| Thermo API endpoints + integration tests | Backend | >90% code coverage on thermo package |
| Performance benchmarking (PT flash < 500 ms) | Backend | P95 latency meets target |
| Data quality audit (flag gaps, estimated values) | Data Eng | Quality report with confidence ratings per compound |
...
- [ ] Data sourcing fully documented (license, ETL, validation methodology)
...
### Sprint 7–8 (Weeks 13–16): Pipe Sizing & Phase Separators
...
### Sprint 9–10 (Weeks 17–20): Heat Exchanger Module
...
### Sprint 11–12 (Weeks 21–24): Datasheets & Polish
...
### Sprint 15–16 (Weeks 29–32): Safety Relief Valves
...
### Sprint 17–18 (Weeks 33–36): Economic Evaluation
...
### Sprint 21–22 (Weeks 41–44): Process Safety
...
### Sprint 23–24 (Weeks 45–48): Advanced Process Control
...
### Sprint 25–26 (Weeks 49–52): Plant Layout
...
### Sprint 27–28 (Weeks 53–56): P&ID Development
...
### Sprint 29–30 (Weeks 57–60): Collaboration & Integration
...
### Sprint 31–34 (Weeks 61–68): Performance & Polish
...
| Date | Milestone |
|---|---|
| Q2 2026 W12 | Thermodynamic Engine validated (Phase 0 complete) |
| Q3 2026 W24 | MVP launch: Pipe + Separator + Heat Exchanger (Phase 1) |
| Q4 2026 W36 | Full sizing + economics loop (Phase 2) |
| Q1 2027 W52 | Advanced design: column + safety + APC (Phase 3) |
| Q3 2027 W68 | Enterprise platform: P&ID + collaboration (Phase 4) |
