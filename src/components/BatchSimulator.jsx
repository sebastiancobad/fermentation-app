        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-sage-200 p-4 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-sage-400">t = {current?.t ?? 0} h</span>
            </div>
            {[
              ...
              <div key={ch.dataKey}>
                <div className="text-xs text-sage-400 mb-1" style={{ color: ch.color }}>{ch.name}</div>
                <ResponsiveContainer width="100%" height={80}>
                  <LineChart data={chartData} margin={{ top: 2, right: 10, bottom: 0, left: -20 }}>
                    ...
                    <Line type="monotone" dataKey={ch.dataKey} stroke={ch.color} strokeWidth={2} dot={false} isAnimationActive={false} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            ))}
