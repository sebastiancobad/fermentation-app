...
function BioSwarm({ count = 40 }) {
  ...
  // Generar posiciones aleatorias para las "células"
...
export default function Dashboard() {
  return (
    <div className="relative min-h-[80vh] w-full">
      {/* Fondo 3D Renderizado en Tiempo Real */}
      <Scene3D />
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <motion.div 
            ...
            className="md:col-span-8 bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-10 md:p-14 shadow-[0_8px_30px_rgba(135,145,134,0.1)] border border-white relative overflow-hidden group"
          >
            ...
            <motion.p 
              ...
              className="text-[10px] font-bold text-[#879186] tracking-[0.2em] uppercase mb-6 flex items-center gap-4"
            >
            ...
            <h2 className="text-4xl md:text-6xl font-light text-[#1a1a1a] tracking-tighter leading-[1.1] mb-8">
              Ingeniería de <br />
              <span className="font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#1a1a1a] to-[#879186]">
                Fermentación.
              </span>
            </h2>
          ...
          <motion.div variants={itemVariants} className="md:col-span-4 flex flex-col gap-6">
            <motion.div 
              whileHover={{ y: -5, boxShadow: "0 20px 40px -10px rgba(135,145,134,0.15)" }}
              className="flex-1 bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-10 border border-white flex flex-col justify-center transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <motion.div 
            ...
            className="md:col-span-7 bg-[#111312] rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden"
          >
